    ...
    it('should add order when all fields in request body are valid - status code 200', function() 
    {
      return request(app)
        ...
        .then(response => {
            ...
            assert.equal(orders[orderID]["name"], "Nadav kaduri")
            ...
            assert.equal(orders[orderID]["main dish"], "Pizza")
            assert.equal(orders[orderID]["side dish"], "Small Salad")
            assert.equal(orders[orderID]["drink"], "Coke")
...
describe('GET /order/:id', function() 
{
    ...
    {  
        ...
        .then(response => {
            ...
            assert.equal(response.body["name"], "Nadav kaduri")
    ...
    it('should update the existing order with that id - status code 200', function() 
    {
      return request(app)
        ...
        .then(response => {
            ...
            assert.equal(orders[orderID]["email"], "nadav@gmail.com")
            assert.equal(orders[orderID]["address"], "tchernichovsky 6/5, beer sheva")
            assert.equal(orders[orderID]["main dish"], "Pasta")
            assert.equal(orders[orderID]["side dish"], "Small Salad")
            assert.equal(orders[orderID]["drink"], "Coke")
